...
public class MainActivity extends AppCompatActivity implements CreadentialDialog.ICredentialsDialogListener{
  GithubApi githubApi;
  String username;
  String password;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btnSend = findViewById(R.id.send_comment_button);
    ...
    repositoriesSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
      ...
      public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if(parent.getSelectedItem() instanceof GithubRepos){
          GithubRepos githubRepos = (GithubRepos) parent.getSelectedItem();
    ...
    txtComment = findViewById(R.id.comment_edittext);
    btnLoadRepos = findViewById(R.id.loadRepos_button);
  ...
  private void showCredentialsDialog(){
    CreadentialDialog dialog = new CreadentialDialog();
    ...
    OkHttpClient okHttpClient = new OkHttpClient.Builder()
        .addInterceptor(new Interceptor(){
          ...
          public Response intercept(Chain chain) throws IOException {
            ...
            Request.Builder builder = originalRequest.newBuilder().header("Authorization", "token 204fa422fd21d4f47a84e53ed6b79a394fcb3389");
//                Credentials.basic(username, password));
  ...
  DisposableSingleObserver<List<GithubRepos>> getRepositoriesObserver(){
    return new DisposableSingleObserver<List<GithubRepos>>() {
      @Override
      public void onSuccess(List<GithubRepos> value) {
        if(!value.isEmpty()){
          ArrayAdapter<GithubRepos> spinnerAdapter = new ArrayAdapter<>(MainActivity.this,
